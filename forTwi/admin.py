...
# Register your models here.
class forTwiAdmin(admin.ModelAdmin): #this class should inherit from admin model admin
...
admin.site.register(models.forTwi, forTwiAdmin) #two arguments one is custom model and custom models class